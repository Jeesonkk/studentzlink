...
import 'package:studentz_link/screens/HomeScreen/TaskScreen_widgets/task_added_to_me_show.dart';
...
class AddedTome extends StatefulWidget {
  const AddedTome({Key? key}) : super(key: key);

  @override
  State<AddedTome> createState() => _AddedTomeState();
}

class _AddedTomeState extends State<AddedTome> {
  ...
  void initState() {
    ...
    taskliststream.gettasklistData(taskstatus: '', created_by: '0');
                          ...
                          onChanged: (newValue) {
                            ...
                            setState(() {
                              ...
                              if (selectedValue == 'Pending') {
                                statusupdate = '0';
                                taskliststream.gettasklistData(
                                    taskstatus: statusupdate, created_by: '0');
                    ...
                    builder: (context, snapshot) {
                      ...
                      return ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          print(taskmodel.response[index].id);
                          return Container(
                            margin: EdgeInsets.only(left: 10, right: 10),
                            child: GlobalWidget().DecorativeContainer(
                              Stack(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    onTap: () {
                                      GlobalData.taskidbyme = taskmodel
                                          .response[index].id
                                          .toString();
                                      print(GlobalData.taskidbyme);
                                      Navigator.push(
                                          context,
                                          MaterialPageRoute(
                                              builder: (context) =>
